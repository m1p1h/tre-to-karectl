...
As AI workloads become more common, empowering researchers and TRE infrastructure engineers to develop and deploy agentic workloads also requires new cost tracking and management capabilities. Cost management therefore has to be treated as a core architectural concern for AI-conformant TREs. Practical controls include local model routing, workload scheduling and quotas abd model right-sizing.
